...
public class BussinessSelect extends JPanel {
    ...
    private void initComponents() {
        ...
        JB_Save.setPreferredSize(new Dimension(85, 30));
        ...
        JB_Withdraw.setPreferredSize(new Dimension(85, 30));
        ...
        JB_MoneyQuery.setPreferredSize(new Dimension(85, 30));
        ...
        add(JB_Password);
        JB_Password.setBounds(new Rectangle(new Point(505, 205), JB_Password.getPreferredSize()));

        //---- JB_Transfer ----
        JB_Transfer.setText(bundle.getString("JB_Transfer.text"));
        JB_Transfer.setPreferredSize(new Dimension(85, 30));
        JB_Transfer.addActionListener(e -> JB_Transfer(e));
        add(JB_Transfer);
        JB_Transfer.setBounds(new Rectangle(new Point(505, 95), JB_Transfer.getPreferredSize()));

        //---- JB_Other ----
        JB_Other.setText(bundle.getString("JB_Other.text"));
        JB_Other.addActionListener(e -> JB_Other(e));
        add(JB_Other);
        JB_Other.setBounds(new Rectangle(new Point(505, 150), JB_Other.getPreferredSize()));
